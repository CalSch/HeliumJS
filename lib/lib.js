...
const Rectangle = (x,y,w,h,rot=0,color) => {
	let self = {
		x,
		y,
		color,
...
const Camera = (x,y) => { //TODO: Add more camera properties
	let self = {
		x,
		y
	};
...
const Game = (canvas, frameRate = 60) => {
	let self, ctx;
